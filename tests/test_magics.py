"""
Comprehensive magic support test suite for runnb.
...
def test_cell_magic_capture():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_capture.ipynb", ns=ns)
...
def test_cell_magic_writefile():
    ...
    ns = {}
    try:
        runnb.run_notebook(FIXTURES / "cell_magic_writefile.ipynb", ns=ns)
...
def test_cell_magic_html():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_html.ipynb", ns=ns)
...
def test_cell_magic_markdown():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_markdown.ipynb", ns=ns)
...
def test_cell_magic_timeit():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_timeit.ipynb", ns=ns)
...
def test_line_magic_timeit():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_timeit.ipynb", ns=ns)
...
def test_line_magic_who_ls():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_who_ls.ipynb", ns=ns)
...
def test_line_magic_env():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_env.ipynb", ns=ns)
...
def test_line_magic_pwd():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_pwd.ipynb", ns=ns)
    cwd = ns["cwd_result"]
...
def test_line_magic_load_ext():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_load_ext.ipynb", ns=ns)
...
def test_line_magic_sx():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_sx.ipynb", ns=ns)
...
def test_line_magic_set_env():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_set_env.ipynb", ns=ns)
...
def test_line_magic_alias_magic():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_alias_magic.ipynb", ns=ns)
...
def test_line_magic_xdel():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_xdel.ipynb", ns=ns)
...
def test_line_magic_reset_selective():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_reset_selective.ipynb", ns=ns)
...
def test_line_magic_psearch():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_psearch.ipynb", ns=ns)
...
def test_line_magic_xmode():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_xmode.ipynb", ns=ns)
...
def test_line_magic_ext_lifecycle():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "line_magic_ext_lifecycle.ipynb", ns=ns)
...
def test_cell_magic_svg():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_svg.ipynb", ns=ns)
...
def test_cell_magic_latex():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_latex.ipynb", ns=ns)
...
def test_cell_magic_javascript():
    ...
    ns = {}
    runnb.run_notebook(FIXTURES / "cell_magic_javascript.ipynb", ns=ns)
